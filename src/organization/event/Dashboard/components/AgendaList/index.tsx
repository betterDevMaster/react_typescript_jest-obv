...
import Heading from 'organization/event/Dashboard/Template/SimpleBlog/Sidebar/Heading'
...
import AddAgendaEventButton from 'organization/event/Dashboard/components/AgendaList/AddAgendaEventButton'
