import {SimpleBlog, SIMPLE_BLOG} from 'organization/event/Dashboard/Template/SimpleBlog'
import faker from 'faker'
import {pipe} from 'ramda'
import {withAgendas} from 'organization/event/Dashboard/components/AgendaList/__utils__/factory'
import {withPoints} from 'organization/event/Dashboard/components/PointsSummary/__utils__/factory'
import {withResources} from 'organization/event/Dashboard/components/ResourceList/__utils__/factory'
import {sometimes} from '__utils__/attributes'
import {withTicketRibbon} from 'organization/event/Dashboard/components/TicketRibbon/__utils__/factory'
import {withEmojiList} from 'organization/event/Dashboard/components/EmojiList/__utils__/factory'
import {withBlogPosts} from 'organization/event/Dashboard/components/BlogPost/__utils__/factory'
import {
  fakeNavButton,
  fakeNavButtonWithSize,
} from 'organization/event/Dashboard/components/NavButton/__utils__/factory'
