import {AND, OR, Rule} from 'organization/event/Dashboard/component-rules'
import {matchesTagsRule} from 'organization/event/Dashboard/component-rules/RuleConfig/RuleList/SingleRule/TagsRule/matcher'
import {NESTED_RULE} from 'organization/event/Dashboard/component-rules/RuleConfig/RuleList/SingleRule/NestedRule'
import {
  GROUP,
  Groups,
} from 'organization/event/Dashboard/component-rules/RuleConfig/RuleList/SingleRule/GroupRule'
import {matchesGroupRule} from 'organization/event/Dashboard/component-rules/RuleConfig/RuleList/SingleRule/GroupRule/matcher'
import {
  TAGS,
  Tags,
