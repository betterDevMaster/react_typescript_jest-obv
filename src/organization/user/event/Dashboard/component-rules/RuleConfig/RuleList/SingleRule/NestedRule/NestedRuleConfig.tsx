...
import RuleList from 'organization/user/event/Dashboard/component-rules/RuleConfig/RuleList'
...
import {
  ...
  NestedRule,
  NESTED_RULE,
} from 'organization/user/event/Dashboard/component-rules/RuleConfig/RuleList/SingleRule/NestedRule'
