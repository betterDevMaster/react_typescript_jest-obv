import {AND, Condition, OR, Rule} from 'organization/user/event/Dashboard/component-rules'
...
import {hasMatch} from 'organization/user/event/Dashboard/component-rules/matcher'
