...
import Heading from 'organization/user/event/Dashboard/Template/SimpleBlog/Sidebar/Heading'
...
import AddResourceButton from 'organization/user/event/Dashboard/components/ResourceList/AddResourceButton'
