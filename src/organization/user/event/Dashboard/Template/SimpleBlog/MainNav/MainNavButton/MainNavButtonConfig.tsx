...
import {NavButtonWithSize} from 'organization/user/event/Dashboard/components/NavButton'
import {
  handleChangeSlider,
...
import RuleConfig, {useRuleConfig} from 'organization/user/event/Dashboard/component-rules/RuleConfig'
import ConfigureRulesButton from 'organization/user/event/Dashboard/component-rules/ConfigureRulesButton'
import {
  useDashboard,
  useUpdateDashboard,
