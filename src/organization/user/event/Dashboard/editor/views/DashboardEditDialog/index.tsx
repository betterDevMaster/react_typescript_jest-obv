...
import {setConfig} from 'organization/user/event/Dashboard/editor/state/actions'
...
import ConfigComponent from 'organization/user/event/Dashboard/editor/views/DashboardEditDialog/ConfigComponent'
