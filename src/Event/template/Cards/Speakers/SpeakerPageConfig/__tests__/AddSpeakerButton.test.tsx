...
import {goToSpeakerConfig} from 'Event/template/Cards/Speakers/SpeakerPageConfig/__utils__/go-to-speaker-config'
...
it('should add a new speaker', async () => {
  ...
  const event = fakeEvent({template: fakeCards(), speakers})
  const {
    findByLabelText,
    findByText,
    findAllByLabelText,
