...
import {goToSponsorConfig} from 'Event/template/Cards/Sponsors/SponsorPageConfig/__utils__/go-to-sponsor-page-config'
...
it('should set sponsor page settings', async () => {
  ...
  fireEvent.change(await findByLabelText('edit sponsors page title'), {
    target: {
      value: title,
    },
  })
