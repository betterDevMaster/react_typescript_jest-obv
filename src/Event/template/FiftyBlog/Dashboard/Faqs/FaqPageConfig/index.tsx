...
import AddFaqButton from 'Event/template/FiftyBlog/Dashboard/Faqs/FaqPageConfig/AddFaqButton'
...
import FiftyBlogFaqPage from 'Event/template/FiftyBlog/Dashboard/Faqs'
...
function FaqPage() {
  ...
  switch (template.name) {
    case FIFTY_BLOG:
      return <FiftyBlogFaqPage isEditMode faqs={faqs} />
    default:
