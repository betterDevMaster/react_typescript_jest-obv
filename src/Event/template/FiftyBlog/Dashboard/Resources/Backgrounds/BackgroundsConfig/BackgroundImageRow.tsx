...
import BackgroundImageEditDialog from 'Event/template/FiftyBlog/Dashboard/Resources/Backgrounds/BackgroundsConfig/BackgroundImageEditDialog'

export default function BackgroundImageRow(props: {background: Background}) {
  const [visibleEditDialog, setVisibleEditDialog] = useState(false)
  const {background} = props
  const {zoomBackgrounds: templateSettings} = useFiftyBlogTemplate()
