...
import BackgroundImageRow from 'Event/template/FiftyBlog/Dashboard/Resources/Backgrounds/BackgroundsConfig/BackgroundImageRow'
...
export default function BackgroundImageTable() {
  ...
  const {zoomBackgrounds: pageSettings} = useFiftyBlogTemplate()
