...
import {Resource} from 'Event/template/FiftyBlog/Dashboard/Resources/ResourceList'
...
import ResourceItemConfig from 'Event/template/FiftyBlog/Dashboard/Resources/ResourceList/ResourceItemConfig'
...
function ResourceItemCard(props: {resource: Resource}) {
  ...
  const {resourceList} = useFiftyBlogTemplate()
