...
import AddSponsorButton from 'Event/template/FiftyBlog/Dashboard/Sponsors/SponsorPageConfig/AddSponsorButton'
...
function SponsorsPageConfigContent() {
  ...
  return (
    <>
      ...
      <FiftyBlogSponsorPage isEditMode sponsors={sponsors} />
    </>
  )
}
