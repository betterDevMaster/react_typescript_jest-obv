...
export const DEFAULT_WAIVER_CONFIG_PROPS: NonNullable<FiftyBlog['waiver']> = {
  buttonText: '',
...
export type FiftyBlogWaiverTemplateProps = NonNullable<FiftyBlog['waiver']>

export type WaiverTemplatePropSetter = <
  K extends keyof FiftyBlogWaiverTemplateProps
>(
  key: K,
) => (value: FiftyBlogWaiverTemplateProps[K]) => void

export interface TemplateFieldProps {
  waiver: FiftyBlogWaiverTemplateProps
