...
export const DEFAULT_WAIVER_CONFIG_PROPS: NonNullable<NiftyFifty['waiver']> = {
  buttonText: '',
...
export type NiftyFiftyWaiverTemplateProps = NonNullable<NiftyFifty['waiver']>

export type WaiverTemplatePropSetter = <
  K extends keyof NiftyFiftyWaiverTemplateProps
>(
  key: K,
) => (value: NiftyFiftyWaiverTemplateProps[K]) => void

export interface TemplateFieldProps {
  waiver: NiftyFiftyWaiverTemplateProps
