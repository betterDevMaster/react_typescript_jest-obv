...
it('should render left panel', async () => {
    ...
    expect( await (findByLabelText("left panel menu Home button")) ).toBeInTheDocument();
    expect( await (findByLabelText("left panel menu Speakers button")) ).toBeInTheDocument();
    expect( await (findByLabelText("left panel menu Resources button")) ).toBeInTheDocument();
    expect( await (findByLabelText("left panel menu Points button")) ).toBeInTheDocument();
